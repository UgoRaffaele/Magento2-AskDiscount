<?php 
namespace UgoRaffaele\AskDiscount\Controller\Index;
...
class Index extends \Magento\Framework\App\Action\Action {
	...
	public function generateTemplate($emailTemplateVariables,$senderInfo,$receiverInfo) {
		...
		$templateText = $this->templateInterface->setId('ask_discount')->setVars($emailTemplateVariables)->processTemplate();
	 
		try {
			
			$transport = $this->_transportBuilder
					->setTemplateIdentifier('ask_discount')
					->setTemplateOptions(
						[
